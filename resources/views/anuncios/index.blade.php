            ...
            <div class='card-body' id="body-anuncios">
                <div class="row mx-auto">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="file" name="file" id="imagen" class="form-control" accept="image/*" required>
                    </div>

                    <div class="col-lg-4">
                        <label>Localización<span class="text-danger">*</span></label>
                        <select class="select-form" id="id_localizacion" name="id_localizacion" style="width:100%"
                            required>
                ...
                <div class="row mt-4">
                    <div class="col-lg-4">
                        ...
                        <select class="select-form" id="id_nacionalidad" name="id_nacionalidad" style="width:100%">
                            <option value=''>Indica la nacionalidad</option>
                            @foreach ($nacionalidades as $item)
                                <option value="{{ $item->id_nacionalidad }}">{{ $item->nacionalidad }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-lg-4">
                        ...
                        <input type="text" name="precio" id="precio" class="form-control"
                            onkeypress="return isNumberKey(event)" placeholder="El valor del precio debe ser en euros">
                    </div>
                    <div class="col-lg-4">
                        <label class="form-label">Telefono<span class="text-danger">*</span></label>
                        <input type="text" name="telefono" id="telefono" class="form-control"
                            onkeypress="return isNumberKey(event)" placeholder="El numero debe tener el indicativo">
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-4">
                        ...
                        <br>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" value="1" id="dispo_lunes"
                                name="disponibilidad[]" checked>
                            <label class="form-check-label" for="dispo_lunes">
                                Lunes
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" value="2" id="dispo_martes"
                                name="disponibilidad[]" checked>
                            <label class="form-check-label" for="dispo_martes">
                                Martes
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" value="3" id="dispo_miercoles"
                                name="disponibilidad[]" checked>
                            <label class="form-check-label" for="dispo_miercoles">
                                Miercoles
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" value="4" id="dispo_jueves"
                                name="disponibilidad[]" checked>
                            <label class="form-check-label" for="dispo_jueves">
                                Jueves
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" value="5" id="dispo_viernes"
                                name="disponibilidad[]" checked>
                            <label class="form-check-label" for="dispo_viernes">
                                Viernes
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" value="6" id="dispo_sabados"
                                name="disponibilidad[]" checked>
                            <label class="form-check-label" for="dispo_sabados">
                                Sabados
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" value="7" id="dispo_domingos"
                                name="disponibilidad[]" checked>
                            <label class="form-check-label" for="dispo_domingos">
                                Domingos
                            </label>
                        </div>
                    </div>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="text" name="peso" id="peso" class="form-control"
                            placeholder="Peso en Kg" onkeypress="return isNumberKey(event)" required>
                    </div>
                    <div class="col-lg-4">
                        ...
                        @foreach ($categorias as $categoria)
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" value="{{ $categoria->id_categoria }}"
                                    id="cate_{{ $categoria->id_categoria }}" name="categorias[]" required>
                ...
                <div class="row mt-1">
                    <div class="col-lg-4">
                        <div id="zone_whatsaap" style="display: none">
                            <label class="form-label">Url Whatsaap</label>
                            <input type="text" name="url_whatsaap" id="url_whatsaap" class="form-control"
                                placeholder="Ej: +348285647899">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div id="zone_telegram" style="display: none">
                            <label class="form-label">Url Telegram</label>
                            <input type="text" name="url_telegram" id="url_telegram" class="form-control" placeholder="{{ __('Ej: @userTelgram') }}">
                        </div>
                    </div>
                </div>

                <div class="row mt-4">
                    <x-primary-button class="ms-4" onclick="agregarAnuncio()">
                        {{ __('Agregar el anuncio') }}
                    </x-primary-button>
                </div>
